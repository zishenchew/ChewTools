...
def rigMake(mayaFalse):
    ...
    '''
    pm.xform(constrLoc, ws=True, t=pm.xform(weapJoint, q=True, t=True,
                                            ws=True))  # moving the newly created constraint locator to the translation position of the joint
...
def rightHandMain(mayaFalse):
    ...
    pm.parentConstraint('Character1_Ctrl_RightWristEffector', 'WeaponMotion_R', mo = True, name = 'Constraint_Weapon_Global')
    '''
    pm.setKeyframe('Controller_Weapon_Global')
    pm.setKeyframe('Controller_Weapon_Global', v = 1, at = 'blendWeaponGlobal', itt = 'auto', ott = 'step')
    '''
...
def leftHandMain(mayaFalse):
    ...
    pm.xform(controller_weapon[0], ws = True, translation = pm.xform('L_AttachmentMotion', q = True, translation = True, ws = True), rotation = (90, 0, 90))
...
def rightMaster(mayaFalse):
    ...
    pm.parentConstraint('Character1_Ctrl_RightWristEffector', 'WeaponMotion_R', mo = True)
    
def leftMaster(mayaFalse):
    pm.setAttr('Character1_Ctrl_LeftWristEffector.rt', 0)
    pm.setAttr('Character1_Ctrl_LeftWristEffector.rr', 0)
    pm.parentConstraint('Character1_Ctrl_LeftWristEffector', 'WeaponMotion_R', mo = True)
