...
def PrismTools_UI():
    ...
    pm.iconTextButton(style = 'iconAndTextVertical',
                      image1 = r'\\p.sv\Tool\Advanced_Skeleton\AdvancedSkeleton5Files\icons\AS5.png',
                      label = 'Adv Skeleton',
                      parent = ASRow,
                      command = AS_button,
                      width = 75)
    picker_button = partial(mel.eval, 'source "//p.sv/Tool/Advanced_Skeleton/AdvancedSkeleton5Files/Selector/biped.mel"')
    pm.iconTextButton(style='iconAndTextVertical',
                      image1=r'\\p.sv\Tool\Advanced_Skeleton\AdvancedSkeleton5Files\icons\asBiped.png', label='Picker',
                      parent=ASRow,
                      command = picker_button,
                      width = 50)
    face_button = partial(mel.eval, 'source "//p.sv/Tool/Advanced_Skeleton/AdvancedSkeleton5Files/Selector/face.mel"')
    pm.iconTextButton(style='iconAndTextVertical',
                      image1=r'\\p.sv\Tool\Advanced_Skeleton\AdvancedSkeleton5Files\icons\asFace.png', label='Picker',
                      parent=ASRow,
                      command = face_button,
                      width = 50)
