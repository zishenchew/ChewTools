...
class MainWindow(QtWidgets.QDialog, Ui_MainWindow):
    ...
    def animExport_2(self):
        ...
        if self.camExport.isChecked() == True:
            mel.eval('setAttr($gGameFbxExporterCurrentNode + ".exportPath") - type "string" "' + r'D:/SER/SVN/Unity/motion/fbx_yard/Assets/CutScenes/CutScene_Special/' + self.fileNameSplit[0] + '";') #setting address
        else:
