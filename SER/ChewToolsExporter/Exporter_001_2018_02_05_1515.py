...
class MainWindow(QtWidgets.QDialog, Ui_MainWindow):
    ...
    def __init__(self, fujiArg, parent=None):
        ...
        if self.fuji == 1:
            self.boneFBX = 'D:/SER_SVN/SVN/Unity/motion/fbx_yard/Assets/Models_Characters'
        ...
        if self.fileType == 'charaMotion':
            ...
            if self.fuji == 1:
                self.exportPathText = 'D:/SER_SVN' + self.weaponPathIndex[self.weaponNumber][6:]
        elif self.fileType == 'charaModel':
    ...
    def animExport_2(self):
        ...
        pm.setAttr('gameExporterPreset2.exportSetIndex', 2)#set export to export selection
