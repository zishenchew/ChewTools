...
class MainWindow(QtWidgets.QDialog, Ui_MainWindow):
    ...
    def animButton(self):
    	#if anim export button was pushed. This function will direct the flow of the export function
    	if self.camera
    	pass
    ...
    def exportAnim(self):
		...
		mel.eval('FBXExport -f "E:/SER working folder/test/test.fbx" -s;')#this is the command that executes the export
